    ...
    <nav class="border-b bg-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative">
                    <input type="text" class="bg-gray-700 rounded-full w-64 px-10 py-2 text-sm focus:outline-none focus:shadow-outline" placeholder="Search">
                        ...
                        <div class="space-x-4">
                            @auth
                                <a
                                    ...
                                    class="font-medium text-white-600 hover:text-gray-300 focus:outline-none focus:underline transition ease-in-out duration-150"
                                >
                                    Log out
                                </a>
                            ...
                            @else
                                <a href="{{ route('login') }}" class="font-medium text-white-600 hover:text-gray-300 focus:outline-none focus:underline transition ease-in-out duration-150">Log in</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="font-medium text-white-600 hover:text-gray-300 focus:outline-none focus:underline transition ease-in-out duration-150">Register</a>
                                @endif
                            @endauth
                        </div>
                    @endif
